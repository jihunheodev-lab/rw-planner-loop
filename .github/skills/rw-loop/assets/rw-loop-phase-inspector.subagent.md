...
- verification policy file: `.ai/tasks/TASK-00-READBEFORE.md`
...
6) Run every command listed under `Phase Gate Verification Commands` in `TASK-00-READBEFORE.md`.
   ...
   - If any command fails (non-zero exit), output `PHASE_INSPECTION=FAIL` and `PHASE_REVIEW_STATUS=NEEDS_REVISION`.
7) If pass:
